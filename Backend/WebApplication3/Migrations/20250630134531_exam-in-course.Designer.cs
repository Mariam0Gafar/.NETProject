...
namespace WebApplication3.Migrations
{
    ...
    [Migration("20250630134531_exam-in-course")]
    partial class examincourse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication3.Data.Faculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication3.Data.Department", b =>
                {
                    b.HasOne("WebApplication3.Data.Faculty", "Faculty")
            ...
            modelBuilder.Entity("WebApplication3.Data.Exam", b =>
                {
                    b.HasOne("WebApplication3.Data.Course", "Course")
                        .WithOne("Exam")
                        .HasForeignKey("WebApplication3.Data.Exam", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
